...
class PhoneInfor_v01 {
	...
	PhoneInfor_v01(String name, String phoneNumber, String birthday) {
//		super(); //상속 
		this.name = name;
...
//	생일은 어차피 string 형태이고 입력되지 않을 경우의 생성자를 따로 설정했으므로
//	아예 문장으로 처리하여 후에 print 메서드에서 조건문을 사용하는 코드를 줄일 수 있다. 
//	public PhoneInfor(String name, String phoneNumber) {
//		this(name, phoneNumber, null);
//	}

	//생성자 생성 및 오버로딩 (생일 입력시와 미입력시 다르게 설정) 
	PhoneInfor_v01(String name, String phoneNumber) {
